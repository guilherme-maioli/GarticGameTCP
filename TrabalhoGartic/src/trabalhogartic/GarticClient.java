...
public class GarticClient extends javax.swing.JFrame {
    ...
    public void pintaBolinha() {
        ...
        listX.add(qtdPintada, x);
        listY.add(qtdPintada, y);
    }
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        String msg = tipo+"|"
                    +desenho+"|"
                    +listX.get(qtdPintada - 1)+"|"
                    +listY.get(qtdPintada - 1)+"|"
                    +cor.toString()+"|"
                    +palpite;
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        ...
        try {
            ...
            tcpClient.writeMessage(String.valueOf(500));
            desenho = jTextField1.getText();
            jPanel1.requestFocus();
        } catch (Exception e) {
